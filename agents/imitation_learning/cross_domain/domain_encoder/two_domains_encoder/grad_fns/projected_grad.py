...
from .base_grad_fn import BaseSourceEncoderGradFn, BaseTargetEncoderGradFn


class TargetEncoderProjectedGradPolicyToStateGradFn(BaseTargetEncoderGradFn):
...
class TargetEncoderProjectedGradStateToPolicyGradFn(BaseTargetEncoderGradFn):
    def process_target_grads(self, *, state_grad, random_policy_grad):
...
class SourceEncoderProjectedGradPolicyToStateGradFn(BaseSourceEncoderGradFn):
...
class SourceEncoderProjectedGradStateToPolicyGradFn(BaseSourceEncoderGradFn):
    def process_source_grads(self, *, state_grad, random_policy_grad, expert_policy_grad):
