...
def get_sample_discriminator_hists(
    ...
    state_learner_logits = apply_model_jit(dida_agent.sample_discriminator, learner_state)
    state_expert_logits = apply_model_jit(dida_agent.sample_discriminator, expert_state)
    ...
    return state_learner_figure, state_expert_figure
